...
function MethodIcon({ method }: { method: PaymentMethod }) {
  ...
  // Stiliserede logo-glyphs · white-label betalings-UI
    ...
    return (
      <div className="text-center py-10">
        ...
        <p className="mt-2 text-[13px] text-muted">
          {step === "3ds"
            ? "Vi har sendt en notifikation til din MitID-app."
            : "Betalingen behandles · få sekunder."}
        </p>
  ...
  return (
    <section className="rise">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3 text-[11px] text-faint">
        ...
        <span>·</span>
        <span>Bedrageribeskyttelse aktiv</span>
      </div>
