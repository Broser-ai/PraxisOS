...
export const bookings: Booking[] = [
  // I dag
  { id: "bk_a1", tenant: "bypilar", clientId: "mette",  clientName: "Mette Lindqvist", clientInitials: "ML", service: "Fod-scan · opfølgning", serviceId: "fod-scan", practitioner: "Pilar", startsAt: isoOffset(0, 8, 30), durationMin: 30, modality: "Klinik", status: "completed", priceKr: 595, paid: true, noShowRisk: 6, source: "online" },
  { id: "bk_a2", tenant: "bypilar", clientId: "jonas",  clientName: "Jonas Brandt", clientInitials: "JB", service: "Medicinsk fodpleje", serviceId: "fod-med", practitioner: "Pilar", startsAt: isoOffset(0, 9, 15), durationMin: 45, modality: "Klinik", status: "confirmed", priceKr: 495, paid: false, noShowRisk: 12, source: "tlf" },
  ...
  { id: "bk_a5", tenant: "bypilar", clientId: "clara",  clientName: "Clara Winther", clientInitials: "CW", service: "Luksus fodpleje", serviceId: "fod-lux", practitioner: "Pilar", startsAt: isoOffset(0, 13, 30), durationMin: 60, modality: "Klinik", status: "confirmed", priceKr: 745, paid: true, noShowRisk: 9, source: "online" },

  // Imorgen
  { id: "bk_b1", tenant: "bypilar", clientId: "mette",  clientName: "Mette Lindqvist", clientInitials: "ML", service: "Luksus fodpleje", serviceId: "fod-lux", practitioner: "Pilar", startsAt: isoOffset(1, 10), durationMin: 75, modality: "Klinik", status: "confirmed", priceKr: 745, paid: true, noShowRisk: 5, source: "online" },
  { id: "bk_b2", tenant: "bypilar", clientId: "jonas",  clientName: "Jonas Brandt", clientInitials: "JB", service: "Medicinsk fodpleje", serviceId: "fod-med", practitioner: "Pilar", startsAt: isoOffset(1, 14), durationMin: 45, modality: "Klinik", status: "confirmed", priceKr: 495, paid: false, noShowRisk: 18, source: "aria" },

  // Næste uge
  { id: "bk_c1", tenant: "bypilar", clientId: "amira",  clientName: "Amira Haddad", clientInitials: "AH", service: "Fod-scan · Physical AI", serviceId: "fod-scan", practitioner: "Pilar", startsAt: isoOffset(4, 11), durationMin: 30, modality: "Klinik", status: "confirmed", priceKr: 595, paid: false, noShowRisk: 22, source: "online" },
  ...
  // Past
  { id: "bk_p1", tenant: "bypilar", clientId: "mette",  clientName: "Mette Lindqvist", clientInitials: "ML", service: "Fod-scan · baseline", serviceId: "fod-scan", practitioner: "Pilar", startsAt: isoOffset(-7, 9), durationMin: 30, modality: "Klinik", status: "completed", priceKr: 595, paid: true, noShowRisk: 0, source: "online" },
  ...
  { id: "bk_p3", tenant: "bypilar", clientId: "jonas",  clientName: "Jonas Brandt", clientInitials: "JB", service: "Medicinsk fodpleje", serviceId: "fod-med", practitioner: "Pilar", startsAt: isoOffset(-14, 13), durationMin: 45, modality: "Klinik", status: "completed", priceKr: 495, paid: true, noShowRisk: 0, source: "online" },
  { id: "bk_p4", tenant: "bypilar", clientId: "clara",  clientName: "Clara Winther", clientInitials: "CW", service: "Luksus fodpleje", serviceId: "fod-lux", practitioner: "Pilar", startsAt: isoOffset(-21, 14), durationMin: 60, modality: "Klinik", status: "noshow", priceKr: 745, paid: false, noShowRisk: 0, source: "online", notes: "Patient mødte ikke op. Aria sendte recovery-flow." },
