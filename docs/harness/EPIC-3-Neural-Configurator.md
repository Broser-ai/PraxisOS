...
**Type:** appendiks der skal *tilføjes* nederst i eksisterende [`docs/harness/EPIC-3-Neural-Configurator.md`](../../../praxisos/docs/harness/EPIC-3-Neural-Configurator.md) (245 linjer). Filen her indeholder KUN den nye sektion — parent workflow appender den efter §9 "Rollback".
