...
**Type:** appendiks der skal *tilføjes* nederst i eksisterende [`docs/harness/EPIC-1-Orchestration.md`](../../../praxisos/docs/harness/EPIC-1-Orchestration.md) (315 linjer). Filen her indeholder KUN den nye sektion — parent workflow appender den efter §9 "Definition of Done for denne kontrakt".
